...
public class HpCFluids {
    ...
    public static final DeferredHolder<FluidType, FluidType> OXYGEN_TYPE = FLUID_TYPES.register("oxygen_gas",
            () -> new FluidType(FluidHelper.createGasProperties("oxygen_gas")));
