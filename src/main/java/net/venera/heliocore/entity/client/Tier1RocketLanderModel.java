...
public class Tier1RocketLanderModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition walls = partdefinition.addOrReplaceChild("walls", CubeListBuilder.create().texOffs(0, 142).addBox(-12.0F, -32.0F, -10.0F, 8.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
				...
				.texOffs(84, 68).addBox(0.0F, -32.0F, -8.0F, 2.0F, 32.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 5.0F, 0.0F));
		...
		PartDefinition engine = partdefinition.addOrReplaceChild("engine", CubeListBuilder.create().texOffs(72, 161).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(114, 156).addBox(-5.0F, -3.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(111, 184).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(49, 179).addBox(-7.0F, -1.0F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, 0.0F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(48, 47).addBox(-9.0F, -19.0F, -9.0F, 18.0F, 3.0F, 18.0F, new CubeDeformation(0.0F))
				.texOffs(17, 0).addBox(9.0F, -16.0F, -8.0F, 7.0F, 5.0F, 16.0F, new CubeDeformation(0.0F))
				...
				.texOffs(165, 0).addBox(-9.0F, -55.0F, -9.0F, 18.0F, 2.0F, 18.0F, new CubeDeformation(0.0F))
