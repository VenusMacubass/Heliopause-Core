...
public class OxygenSealerMenu extends AbstractContainerMenu {
    public final OxygenSealerEntity blockEntity;
    private final Level level;
    public final ContainerData data;

    public OxygenSealerMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public OxygenSealerMenu(int containerId, Inventory  inventory, BlockEntity blockEntity) {
        super(HpCMenuTypes.OXYGEN_SEALER_MENU.get(), containerId);
        this.blockEntity = ((OxygenSealerEntity)blockEntity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, HpCBlocks.OXYGEN_SEALER_BLOCK.get());
    }
    ...
    public boolean isSealed() { return data.get(6) == 1;}
