...
public class GasCompressorMenu extends AbstractContainerMenu {
    public final GasCompressorEntity blockEntity;
    private final Level level;
    public final ContainerData data;

    public GasCompressorMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public GasCompressorMenu(int containerId, Inventory  inventory, BlockEntity blockEntity) {
        super(HpCMenuTypes.GAS_COMPRESSOR_MENU.get(), containerId);
        this.blockEntity = ((GasCompressorEntity)blockEntity);
