    ...
    public static final Supplier<CreativeModeTab> HELIOPAUSE_CORE_ITEMS = CREATIVE_MODE_TAB.register(HeliopauseCore.MOD_ID + "_items",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(HpCItems.OXYGEN_CONNECTORS.get());
                        ...
                        output.accept(HpCItems.BASIC_CIRCUIT_BOARD.get());
    ...
    public static final Supplier<CreativeModeTab> HELIOPAUSE_CORE_BLOCKS = CREATIVE_MODE_TAB.register(HeliopauseCore.MOD_ID + "_blocks",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(HpCBlocks.BASE_BUILDING_WALL_WHITE.get());
                        output.accept(HpCBlocks.BASE_BUILDING_STAIRS_WHITE.get());
                        output.accept(HpCBlocks.BASE_BUILDING_SLAB_WHITE.get());
                        
                        output.accept(HpCBlocks.BASE_BUILDING_BLACK_BLOCK.get());
                        output.accept(HpCBlocks.BASE_BUILDING_WALL_BLACK.get());
                        output.accept(HpCBlocks.BASE_BUILDING_STAIRS_BLACK.get());
                        output.accept(HpCBlocks.BASE_BUILDING_SLAB_BLACK.get());
