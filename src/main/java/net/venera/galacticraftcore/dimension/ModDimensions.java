...
public class ModDimensions {
        ...
        MultiNoiseBiomeSource moonBiomeSource = MultiNoiseBiomeSource.createFromList(
                new Climate.ParameterList<>(List.of(
                        ...
                        Pair.of(Climate.parameters(
                                ...
                                0.0F
                        ), biomeRegistry.getOrThrow(ModBiomes.LUNAR_MARIA)), // Replace with your actual biome key
                        ...
                        Pair.of(Climate.parameters(
                                ...
                                Climate.Parameter.span(-1.0F, 1.0F), // Weirdness 
                                0.0F
                        ), biomeRegistry.getOrThrow(ModBiomes.LUNAR_HIGHLANDS)) // Replace with your actual biome key
                ))
        );

        LevelStem moonStem = new LevelStem(
                dimTypes.getOrThrow(ModDimensions.MOON_TYPE_KEY),
                new NoiseBasedChunkGenerator(moonBiomeSource, noiseSettings.getOrThrow(ModNoiseSettings.MOON_NOISE_SETTINGS_KEY))
        );
    ...
    public static void typeBootstrap(BootstrapContext<DimensionType> context) {
        context.register(MOON_TYPE_KEY, new DimensionType(
                ...
                ResourceLocation.fromNamespaceAndPath(GalacticraftCore.MOD_ID, "moon"), // effectsLocation 
                0.0f,                 // ambientLight 
