package net.venera.galacticraftcore.entity.zombie;
...
public class SpaceZombieRenderer extends MobRenderer<SpaceZombieEntity, ZombieModel<SpaceZombieEntity>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GalacticraftCore.MOD_ID, "textures/entity/space_zombie.png");
