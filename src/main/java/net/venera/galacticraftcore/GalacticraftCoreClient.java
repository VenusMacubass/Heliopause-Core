...
public class GalacticraftCoreClient {
    ...
    static void onClientSetup(final FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModRegistry.CRUDE_OIL.getSource(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(ModRegistry.CRUDE_OIL.getFlowing().value(), RenderType.translucent());
